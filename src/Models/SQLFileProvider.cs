...
{
    public class SQLFileProvider : IFileManagerProviderBase
    {
        // your data table
        ...
        public SQLFileProvider(IConfiguration configuration)
        {
            ...
            this.ConnectionString =  configuration.GetConnectionString("FileManagerConnection");
        }
        ...
        public void SetSQLSettings(string SQLTableName, string rootNodeId)
        {
        ...
        public FileManagerResponse GetFiles(string path, bool showHiddenItems, params FileManagerDirectoryContent[] data)
        {
           ...
           "select * from " + this.TableName + "";
            ...
            try
            {
                ...
                //string querystring = "select Name,Size,isFile,DateModified,DateCreated,HasChild from Product where ParentID=" +id +"";
                string querystring = "";
                if (data.Length == 0)
                {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    var d = new FileManagerDirectoryContent
                    {
                        Name = reader["Name"].ToString().Trim(),
                        Size = (long)reader["Size"],
                        IsFile = (bool)reader["IsFile"],
        ...
        public FileManagerResponse CreateFolder(string path, string name, params FileManagerDirectoryContent[] data)
        {
            ...
            try
            {
                ...
                //string querystring = "select * from " + this.TableName + " where ParentID='" + data[0].id + "'";
        ...
        public virtual FileManagerResponse Upload(string path, IList<IFormFile> uploadFiles, string action, string[] replacedItemNames, params FileManagerDirectoryContent[] data)
        {
            ...
            //var ds= FileToByteArray(uploadFiles[0].FileName);
            //FileStream fileStream = new FileStream(uploadFiles[0].FileName, FileMode.Open);
            try
            {
