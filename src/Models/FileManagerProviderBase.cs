...
namespace FileManager
{
    ...
    public class FileManagerProviderBase : IFileManagerProviderBase
    {
        ...
        public virtual FileManagerResponse CreateFolder(string path, string name, params FileManagerDirectoryContent[] data)
        {
        ...
        public virtual FileManagerResponse GetDetails(string path, string[] names, params FileManagerDirectoryContent[] data)
        {
        ...
        public virtual FileManagerResponse Upload(string path, IList<IFormFile> uploadFiles, string action, string[] replacedItemNames, FileManagerDirectoryContent[] data)
        {
